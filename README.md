...
v1.1.0 — adds the `md-to-gdoc` skill (markdown → Google Doc via the Drive API). See the [latest release notes](https://github.com/sand4rbh/kimono/releases/latest).
...
```bash
cargo install --git https://github.com/sand4rbh/kimono --tag v1.1.0
```
